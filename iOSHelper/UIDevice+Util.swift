...
//  KelvinAndrew
//
//  Created by Kelvin Kosbab on 5/13/15.
...
public extension UIDevice {
  ...
  class var deviceInformation: [String: String] {
    return ["device_identifier": self.deviceUUID, "device_model": self.modelName, "mobile_auth_token": "", "device_token": ""]
  }
  ...
  var modelName: String {
    ...
    for i in mirror.children {
      ...
      identifier.append(UnicodeScalar(UInt8(i.1 as! Int8)))
    }
  ...
  var iPhone4: Bool {
    return self.modelName.rangeOfString("iPhone 4") != nil
  }
  
  var iPhone5: Bool {
    return self.modelName.rangeOfString("iPhone 5") != nil
  }
  
  var iPhone6: Bool {
    return self.modelName == "iPhone 6"
  }
  
  var iPhone6Plus: Bool {
    return self.modelName == "iPhone 6 Plus"
  }
  
  // MARK: Tablets
  
  var iPad1: Bool {
    return self.modelName == "iPad 1"
  }
  
  var iPad2: Bool {
    return self.modelName == "iPad 2"
  }
  
  var iPad3: Bool {
    return self.modelName == "iPad 3"
  }
  
  var iPad4: Bool {
    return self.modelName == "iPad 4"
  }
  
  var iPadAir1: Bool {
    return self.modelName == "iPad Air 1"
  }
  
  var iPadAir2: Bool {
    return self.modelName == "iPad Air 2"
  }
  
  var iPadMini1: Bool {
    return self.modelName == "iPad Mini 1"
  }
  
  var iPadMini2: Bool {
    return self.modelName == "iPad Mini 2"
  }
